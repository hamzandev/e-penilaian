          ...
          <div class="row flex-fill align-items-center">
            <div class="col">
                ...
                @if(Auth::user()->role == 'admin')
                    ...
                    {{-- Akademik --}}
                    <li class="nav-item dropdown {{ Str::contains(Request::path(), 'manage-users') || Str::contains(Request::path(), 'accounts') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ Str::contains(Request::path(), 'accounts') ? 'active' : '' }}" href="{{ route('accounts.index') }}" >
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                <a class="dropdown-item {{ Str::contains(Request::path(), 'manage-users') ? 'active' : '' }}" href="{{ route('manage-users.index') }}" >
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
