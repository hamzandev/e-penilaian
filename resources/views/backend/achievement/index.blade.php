<x-app-layout title="Siswa Berprestasi">
    <div class="col-md-7 ">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-baseline">
                        <h1>Kelas</h1>
                        <a href="{{ route('master-data.academics.create') }}" class="btn btn-primary"><svg
                                ...
                                <path d="M9 12h6" />
                                <path d="M12 9v6" />
                            </svg>Tambah Siswa Berprestasi</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($kelas as $i => $k)
                                    <tr>
                                        ...
                                        <td>{{ $k->name }}</td>
                                        <td>
                                            <a href="{{ route('master-data.academics.edit', $k->id) }}" class="badge bg-primary text-white">
                                            ...
                                            <form style="display: inline;" method="POST" action="{{ route('master-data.academics.destroy', $k->id) }}">
                                                @csrf
                                                @method('DELETE')
