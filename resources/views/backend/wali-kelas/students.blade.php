                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (auth()->user()->role == 'admin')
                                                    ...
                                                    @else
                                                    <a href="{{ route('wali-kelas.students.detail', [$studentsOfClass->id, $studentsOfClass->teacher->id, $k->id]) }}" class="badge bg-orange text-white">
