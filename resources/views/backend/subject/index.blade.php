                            ...
                            <tbody>
                                @foreach ($subject as $i => $k)
                                    <tr>
                                        ...
                                        <td>{{ $k->description ?? '-' }}</td>
                                        <td>
                                            <a href="{{ route('master-data.subject.edit', $k->id) }}" class="badge bg-primary text-white">
                                            ...
                                            <form style="display: inline;" method="POST" action="{{ route('master-data.subject.destroy', $k->id) }}">
                                                @csrf
                                                @method('DELETE')
